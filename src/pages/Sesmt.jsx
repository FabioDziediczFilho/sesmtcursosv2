                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center', marginBottom: '5rem' }}>
                        <div>
                            ...
                            <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', lineHeight: '1.6' }}>
                                Nossa consultoria SESMT vai além do papel. Implementamos uma cultura de segurança real, reduzindo acidentes e garantindo o compliance total da sua empresa com a legislação vigente.
                            </p>
                        </div>
                        <div style={{ height: '500px', background: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url(${sesmtHero})`, backgroundSize: 'cover', backgroundPosition: 'center', border: '1px solid var(--industrial-border)', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
                        </div>
                    </div>
